...
var routes = [
	...
	{ method:'get', path:'/admin/post/comment/:id/remove/:i', exec:adminController.removePostComment },
	{ method:'all', path:'/admin/post/*/?:id?', exec:adminController.validatePost },
	{ method:'post', path:'/admin/post/add', exec:adminController.addPostPOST },
	{ method:'post', path:'/admin/post/edit/:id', exec:adminController.editPostPOST },
